...
// This class provides functional testing of a single activity. The activity under test will be
// created using the system infrastructure (by calling InstrumentationTestCase.launchActivity())
