...
public final class BluetoothUtils {
    public final static int REQUEST_ENABLE_BT = 2001;   // to enable bluetooth through system activity
    ...
    public BluetoothUtils(final Activity activity) {
        ...
        // to perform fundamental Bluetooth tasks
    ...
    public boolean isBluetoothOn() {
        if (mBluetoothAdapter == null) {
            ...
            return mBluetoothAdapter.isEnabled();   // return true if Bluetooth is ready for use
        }
    }
}
