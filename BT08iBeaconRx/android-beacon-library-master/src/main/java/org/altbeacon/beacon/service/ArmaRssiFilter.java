...
public class ArmaRssiFilter implements RssiFilter {
    ...
    public void addMeasurement(Integer rssi) {
        ...
        // Comment: very little variation since the new value rssi account for 10% (armaSpeed) of
        // the value change, no timestamp
    ...
    public boolean noMeasurementsAvailable() {
        return false;
    } // Comment: always has value armaMeasurement = 0
    ...
    // Comment: DEFAULT_ARMA_SPEED is subject to change
