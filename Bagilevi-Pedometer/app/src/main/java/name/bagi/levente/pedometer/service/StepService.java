...
public class StepService extends Service {
    ...
    public void onCreate() {
        ...
        mDistanceNotifier = new DistanceNotifier(mDistanceListener, mPedometerSettings, mSpeakingUtils);
        ...
        mCaloriesNotifier = new CaloriesNotifier(mCaloriesListener, mPedometerSettings, mSpeakingUtils);
        mCaloriesNotifier.setCalories(mCalories = mState.getFloat("calories", 0));
        mStepDetector.addStepListener(mCaloriesNotifier);
        
        mSpeakingTimer = new SpeakingTimer(mPedometerSettings, mSpeakingUtils);
