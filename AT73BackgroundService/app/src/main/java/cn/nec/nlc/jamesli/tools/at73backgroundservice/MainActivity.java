...
public class MainActivity extends FragmentActivity implements OnBackStackChangedListener {
    ...
    // An instance of the status broadcast receiver, extends BroadcastReceiver
    // handle Constants.EXTENDED_DATA_STATUS in onReceive()
    ...
    // handle Constants.ACTION_VIEW_IMAGE / Constants.ACTION_ZOOM_IMAGE
    ...
    public void onBackStackChanged() {
        ...
        // Gets a FragmentManager instance, return FragmentManager for interacting with fragments
        // associated with this activity.
        FragmentManager localFragmentManager = getSupportFragmentManager();

        // Sets the current back stack count, Return no. of entries currently in the back stack
    ...
    public void onCreate(Bundle stateBundle) {
        // Sets fullscreen-related flags for the display, setFlags (int flags, int mask)
        // Goes before LayoutInflater
        getWindow().setFlags(
        ...
        // The filter's action is BROADCAST_ACTION, intent matching one of the set actions will be passed
        ...
        // intent matching all of the set categories will be passed
        ...
        // If any schemes are included in the filter, then an Intent's data must be either
        // one of these schemes or a matching data type.
         ...
         * FragmentManager. Already defined in the method onBackStackChanged().
         */
